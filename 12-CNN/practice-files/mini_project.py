...
# Define tranformations with data augmentation
...
class EnhancedCNN(nn.Module):
    def __init__(self):
        ...
        # Calculate size of output from the convolutional layers dynamically
    ...
    def _calculate_conv_output(self):
        # Dummy input tensor with same size as input images
