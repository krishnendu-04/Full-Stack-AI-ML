...
history = model_tf.fit(X_train,y_train, epochs=5, batch_size=32, validation_split=0.2)
loss_tf, accuracy_tf = model_tf.evaluate(X_test,y_test)
...
model_py = RNNModel(vocab_size=10000,embedding_dim=128,hidden_dim=128,output_dim=1)
...
evaluate_rnn(model_py, X_test, y_test)